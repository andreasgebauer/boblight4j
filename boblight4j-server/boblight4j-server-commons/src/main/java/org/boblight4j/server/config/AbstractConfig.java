...
public abstract class AbstractConfig implements Config {
	...
	protected boolean checkColorConfig() {
		// TODO implement color config validator
		return true;
	}

	protected boolean checkDeviceConfig() {
		// TODO implement device config validator
		return true;
	}

	protected void checkGlobalConfig() throws BoblightException {
		boolean valid = true;
	...
	protected boolean checkLightConfig() {
	...
	@Override
	public void loadConfigFromFile(final File file)
